...
const autores = document.querySelector("#aut");
...
let frases = [
    ...
    "Cuando es verdadera, cuando nace de la necesidad de decir, a la voz humana no hay quien la pare. Si le niegan la boca, ella habla por las manos, o por losojos, o por los poros, o por donde sea",
    " Nunca pensé que en la felicidad hubiera tanta tristeza",
    "Las cosas simples son las más extraordinarias y sólo los sabios consiguen verlas"];
let autor = ["Eduardo Galeano", "Oscar Wilde", "Eduardo Galeano.", "Mario Benedetti", "Paulo Coelho"]
...
function PoneFrase() {
    ...
    autores.innerHTML = autor[textoActual];
}
